...
const uint8_t  eepromMap_activationStatus                = 0x00;
const uint8_t  eepromMap_configRegister                  = 0x01;
const uint16_t eepromMap_enableRegister                  = 0x02;
const uint16_t eepromMap_configAirThingsWavePlusActiveID = 0x04;
const uint16_t eepromMap_configStructSize                = 0x06;
const uint8_t  eepromMap_TBD_0x08                        = 0x08;
const uint8_t  eepromMap_TBD_0x09                        = 0x09;
const uint8_t  eepromMap_TBD_0x0A                        = 0x0A;
const uint8_t  eepromMap_TBD_0x0B                        = 0x0B;
const uint8_t  eepromMap_TBD_0x0C                        = 0x0C;
const uint8_t  eepromMap_TBD_0x0D                        = 0x0D;
const uint8_t  eepromMap_TBD_0x0E                        = 0x0E;
const uint8_t  eepromMap_TBD_0x0F                        = 0x0F;
